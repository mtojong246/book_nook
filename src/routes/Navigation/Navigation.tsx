        ...
        <>
            <div className='w-full bg-tertiary-color'>
                <div className='w-screen max-w-[1440px] mx-auto p-4 md:px-5 flex justify-between items-center gap-3 md:gap-5'>
                    <Link to='/'><p className='font-light text-[28px]'>book<span className='font-semibold'>nook</span></p></Link>
                    <div className='flex justify-center items-center'>
                        <Link to='/'><button className='hidden md:block px-3'>Home</button></Link>
                        <button className='hidden md:block px-3'>My Books</button>
                        <button className='hidden md:block px-3'>Browse</button>
                    </div>
